...
class FilterItem : FrameLayout, Serializable {
    ...
    init {
        ...
        buttonCancel.supportBackgroundTintList = ColorStateList.valueOf(getColor(filterIconTint))
        isIncreased = true
    }

    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        super.onMeasure(widthMeasureSpec, heightMeasureSpec)
        buttonCancel.setBackgroundResource(filterIcon)
    ...
    private fun updateBackground() {
        ...
        drawable.cornerRadius = cornerRadius * 20
